    ...
    <section class="flex items-center hero">
      ...
      >
        <h1 class="text-3xl md:text-5xl leading-tight font-semibold">
          Tempatnya <br class="" /> Produk UMKM Terbaik
        </h1>
        <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
          Kami menyediakan produk UMKM berkelas yang
          <br class="hidden lg:block" />memenuhi kebutuhan anda
        </h2>
        <div>
          <a
            href="#browse-the-room"
            class="bg-yellow-700 text-white hover:bg-yellow-800 hover:text-white rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200"
            >Katalog</a
          >
        </div>
      </div>
      <div class="w-full inset-0 md:relative md:w-1/2">
        <div class="relative hero-image">
          ...
          <img
            src="/frontend/images/content/batik.jpeg"
            alt="Batik Indonesia"
